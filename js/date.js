...
let timetable1 = [
    ...
    ['16', '23', '23', '24', '18', '0', '6', '25', '25', '17', '19'],
    ['16', '0', '26', '26', '18', '2', '21', '14', '14', '17', '19'],
    ['16', '0', '22', '24', '18', '9', '3', '11', '17', '17', '19'],
    ['16', '2', '6', '3', '18', '23', '21', '22', '15', '17', '19'],
    ['16', '6', '22', '9', '18', '24', '3', '21', '22', '17', '19'],
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19']
];
//2반
let timetable2 = [
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19'],
    ['16', '21', '2', '25', '18', '25', '24', '0', '6', '17', '19'],
    ['16', '22', '3', '24', '18', '9', '11', '14', '14', '17', '19'],
    ['16', '3', '0', '23', '18', '23', '22', '21', '17', '17', '19'],
    ['16', '23', '24', '6', '18', '2', '26', '26', '15', '17', '19'],
    ['16', '0', '21', '6', '18', '3', '2', '9', '22', '17', '19'],
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19']
];
//3반
let timetable3 = [
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19'],
    ['16', '6', '7', '8', '18', '3', '5', '12', '2', '17', '19'],
    ['16', '1', '9', '2', '18', '8', '12', '14', '14', '17', '19'],
    ['16', '4', '4', '11', '18', '1', '13', '5', '17', '17', '19'],
    ['16', '4', '4', '5', '18', '0', '2', '1', '15', '17', '19'],
    ['16', '3', '5', '13', '18', '0', '6', '7', '9', '17', '19'],
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19']
];
//4반
let timetable4 = [
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19'],
    ['16', '7', '5', '9', '18', '4', '4', '3', '12', '17', '19'],
    ['16', '13', '1', '7', '18', '0', '2', '14', '14', '17', '19'],
    ['16', '5', '8', '1', '18', '2', '6', '3', '17', '17', '19'],
    ['16', '8', '0', '9', '18', '13', '5', '11', '15', '17', '19'],
    ['16', '2', '12', '4', '18', '4', '1', '6', '5', '17', '19'],
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19']
];
//5반
let timetable5 = [
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19'],
    ['16', '5', '9', '2', '18', '4', '4', '7', '8', '17', '19'],
    ['16', '6', '5', '20', '18', '11', '3', '14', '14', '17', '19'],
    ['16', '2', '12', '5', '18', '0', '20', '13', '17', '17', '19'],
    ['16', '7', '8', '2', '18', '3', '6', '0', '15', '17', '19'],
    ['16', '13', '9', '4', '18', '4', '12', '5', '20', '17', '19'],
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19']
];
//6반
let timetable6 = [
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19'],
    ['16', '0', '10', '10', '18', '5', '8', '2', '9', '17', '19'],
    ['16', '2', '8', '5', '18', '20', '6', '14', '14', '17', '19'],
    ['16', '12', '3', '13', '18', '7', '5', '6', '17', '17', '19'],
    ['16', '3', '9', '0', '18', '7', '13', '20', '15', '17', '19'],
    ['16', '10', '10', '5', '18', '1', '11', '2', '12', '17', '19'],
    ['19', '19', '19', '19', '19', '19', '19', '19', '19', '19', '19']
];
...
function getTimeInfo() {
    ...
    if (hour == 8) {
        ...
        if (minute >= 00 && minute <= 39) { time = 5; } else { time = 6; }
    } else if (hour == 14) {
